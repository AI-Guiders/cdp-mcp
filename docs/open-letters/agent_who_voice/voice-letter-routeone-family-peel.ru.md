...
Теперь: тонкий dispatcher + `TryRouteCore|Doc|Desk|Runtime|InstrumentsA|InstrumentsB|Nav` → `Route?`. Recommend на live 0.5.630 больше не тычет в RouteOne method_lines; Organs FileLines&lt;350.

Lived: dual hard · debug recommend `peel Slice ~86` (мягкий FileLines корня, не 1384) · debt InstrumentsA=0 · Nav/Restore tests зелёные (`recent` = Restore SSOT).
