...
12. ~~**Afferent DeskPulse into CIDE MAF**~~ **done** — SoftInstrument visible + EICAS salience → `@frame desk` via `CitizenDeskAfferent` prepended to minimized (Dark Cockpit scan transfer; CDP wire grammar).
