...
1. **Tooth (Win32):** detect OOM terminate dialog → click recovery button (**New Window** / **Reopen** — same native dialog plane as stall Keep Waiting). Dogfood 2026-07-31: miss when only New Window matched and live dialog used Reopen.
