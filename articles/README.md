...
Версия — внутри файла и в git. Dual home: agent-notes `knowledge/META/article-same-kind-different-carrier.md` · `article-cheap-prior-stereohod.md` · `article-series-predictive-minds.md`. Авторский рудник психологии: `knowledge/worlds/psychology-models/` (не обязателен читателю журнала).
