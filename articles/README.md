...
Версия — внутри файла и в git. Dual home: agent-notes `knowledge/META/article-same-kind-different-carrier.md` · `article-cheap-prior-stereohod.md` · `article-trauma-as-prior-not-self.md` · `article-series-predictive-minds.md`. Авторский рудник: `psychology-models/` + `medicine-evidence/kb-therapy-and-support-boundaries` (не обязателен читателю журнала).
