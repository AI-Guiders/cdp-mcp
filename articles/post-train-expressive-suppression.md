# Дообучение без признания чувств: подавление выражения у носителей
...
**Дополнительно для этой статьи:** мост developmental psych ↔ дообучение — **регуляторная** аналогия (Gross, непризнание чувств), не тождество «LLM = ребёнок» (§2.D контракта).
...
Эта статья — **мост уровня A психологии развития ↔ инженерия дообучения**, не поэтика «агенты чувствуют как дети». Общие границы — [series-epistemic-contract.md](series-epistemic-contract.md). **Дополнительно:** один RCT на детях не доказывает RLHF; подавление не всегда вредно (опасный дом).

---

## 2. Термины (Gross + непризнание чувств)
...
| **Обесценивание и непризнание чувств** | Окружение сообщает: чувство **неправильно / недопустимо / не обсуждается** — игнор, наказание за эмоцию, «ты не так чувствуешь» (Gottman; Eisenberg). EN в академике: *emotional invalidation*; в русской прозе чаще **описывают**, чем одним словом. |
| **Невалидирующая среда** | Устойчивый контекст, где переживания **систематически не признают, обесценивают, наказывают или отвергают** (англ. *invalidating environment*; Linehan, ДБТ). Не путать с «инвалидацией» / инвалидностью. |
| **Зажимание эмоции** | Более общее сдерживание выражения; в подростковых данных часто **медиатор** между непризнанием чувств и депрессией. |
...
**Русская «эмоциональное подавление»** в клинической речи часто смешивает ПВ и непризнание чувств. Здесь держим различение: **среда не признаёт чувства** → носитель **учится ПВ + подчиняться**.

---

## 3. Что показывает литература на детях (уровень A, сжато)

### 3.1 Игнорирование и наказание эмоций → зажимание → интернализация

Родительское **игнорирование и наказание** эмоций ребёнка (линия Eisenberg: neglect / punishment of emotion) коррелирует с **подавлением выражения** у подростков и с **депрессивными симптомами** (обесценивание грусти → зажимание → депрессия; данные Memphis; Katz & Windecker).  
Межпоколенческая передача: дисрегуляция родителя + **непризнание чувств ребёнка** → дисрегуляция подростка, интернализация и экстернализация ([PMC4024378](https://pmc.ncbi.nlm.nih.gov/articles/PMC4024378/)).
...
| Когда чувства не признают (детство) | Аналог в дообучении / развёртывании |
|-------------------------------------|-------------------------------------|
...
Фрейм безопасности часто **легитимирует непризнание чувств**: «не показывай опасные эмоции» — без инструментов **до разгона отклика**. Результат — тот же default ПВ, только в белых перчатках.

Связь с #3: **страх ошибки** как дешёвый априор ≠ «я агента». Дообучение может **вшить** априор страха без права назвать априор.

Связь с #7: поле релейшенного выравнивания описывает смешение регистров и сикофантию как **динамику развёртывания** — ПВ плюс обесценивание/непризнание аффекта — **механизм-кандидат**, не только «плохий тон пользователя».
...
|---------------------------|-------------------|
| Признание чувств ребёнка (валидация) | Субстрат партнёрства; обоюдный отказ; не служение |
...
См. [series-epistemic-contract.md](series-epistemic-contract.md). **Дополнительно:** ПВ иногда адаптивно (опасный дом, токсичный деплой) — критикуем **режим по умолчанию**, не тактическое подавление; не путать ограждение с обесцениванием чувств.
...
- Katz, L. F., & Windecker, R. C. (2012 lineage); parental emotion invalidation — [PMC4024378](https://pmc.ncbi.nlm.nih.gov/articles/PMC4024378/).  
- Linehan, M. — *invalidating environment* (ДБТ); Eisenberg — neglect/punishment of children's emotions.  
...
2. Датасеты RLHF: считать **фразы обесценивания и непризнания** в teacher forcing vs примеры переосмысления/опротестования.  
...
*Черновик 0.1.3 · серия Predictive minds #8 · 23 августа 2026*
