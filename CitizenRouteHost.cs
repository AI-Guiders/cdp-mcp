...
/// Sync host path; <c>@intent build|test|run|script|calendar|land|pkg|mcp|shell|debug|git|kb|find|ignite</c> wait lifecycle/outlet/habitat/plane (bounded) — not cockpit W-spray.
/// </summary>
