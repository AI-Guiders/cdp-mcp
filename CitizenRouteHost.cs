...
internal static partial class CitizenRouteHost
{
    ...
    static Applied ApplyOne(CitizenIntentRouter.Route route)
    {
        ...
        return route.Verb switch
        {
            ...
            CitizenIntentRouter.Verb.FilePeek => RunFilePeek(route),
            CitizenIntentRouter.Verb.DialogMemory => RunDialogMemory(route),
            ...
            CitizenIntentRouter.Verb.Edit => CitizenBufferEdit.Execute(route, EditCallOverride),
            CitizenIntentRouter.Verb.Deploy => RunDeploy(route),
            CitizenIntentRouter.Verb.Undo => CitizenBufferUndo.Execute(route, UndoCallOverride),
            CitizenIntentRouter.Verb.Clip => CitizenBufferClip.Execute(route, ClipCallOverride),
            CitizenIntentRouter.Verb.ReplaceAll => CitizenBufferReplaceAll.Execute(route, ReplaceAllCallOverride),
            CitizenIntentRouter.Verb.Nav => CitizenBufferNav.Execute(route, NavCallOverride),
            CitizenIntentRouter.Verb.Put => CitizenBufferPut.Execute(route, PutCallOverride),
            CitizenIntentRouter.Verb.Scratch => CitizenBufferScratch.Execute(route, ScratchCallOverride),
            CitizenIntentRouter.Verb.Take => CitizenBufferTake.Execute(route, TakeCallOverride),
            CitizenIntentRouter.Verb.Share => CitizenBufferShare.Execute(route, ShareCallOverride),
            CitizenIntentRouter.Verb.Disk => CitizenBufferDisk.Execute(route, DiskCallOverride),
            CitizenIntentRouter.Verb.Sniper => CitizenBufferSniper.Execute(route, SniperCallOverride),
            CitizenIntentRouter.Verb.Buffer => CitizenBufferBuffer.Execute(route, BufferCallOverride),
            CitizenIntentRouter.Verb.FindBuf => CitizenBufferFindBuf.Execute(route, FindBufCallOverride),
