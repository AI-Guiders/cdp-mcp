...
internal static class CdpGraphqlChannel
{
    ...
    static object ExamplesCard() => new
    {
        ...
        examples = new object[]
        {
            ...
            new { id = 13, title = "knowledge hot + route L0", query = "{ knowledge { hotContext { ok schema hint rawJson } routeContext(query: \"mutate plan kb router\") { ok schema hint rawJson } } }" },
        }
    };
