...
{
    public static string? Resolve(string bin) => global::AIGuiders.Platform.Cockpit.Channels.EnvironmentReadiness.DataAcquisition.ToolchainPathProbe.Resolve(bin);

    public static void RefreshProcessPath() =>
        global::AIGuiders.Platform.Cockpit.Channels.EnvironmentReadiness.DataAcquisition.ToolchainPathProbe.RefreshProcessPath();
}
