        ...
        IReadOnlyDictionary<string, JsonElement> args)
    {
        ...
        return new
        {
            ...
            hint =
                ...
                "REPL: feature|task Y @act|focus|done|park|defer|drop|start|shipped|start_phase|complete_phase|events|note|criteria|criterion dor|ac|dod|change_plan seed|anchor|check|ack|phase act|share report|share plan|promote|confirm|reject. " +
