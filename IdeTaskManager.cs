        ...
        try
        {
            ...
            return new
            {
                ...
                hint =
                    ...
                    "REPL: feature|task Y @act #CDP|focus|done|park|defer|drop|start|shipped|await_operator|wave seed|wave scene|wave start|wave item done|wave shipped|wave clear|start_phase|complete_phase|events|note|criteria|criterion dor|ac|dod|change_plan seed|anchor|check|ack|leftover|leftover apply|product CDP|phase act|share report|share plan|promote|confirm|reject. " +
