        ...
        IReadOnlyDictionary<string, JsonElement> args)
    {
        ...
        return new
        {
            ...
            hint =
                ...
                "REPL: feature|task Y @act|focus|done|park|drop|start|shipped|start_phase|complete_phase|events|note|phase act|share report|share plan|promote|confirm|reject. " +
