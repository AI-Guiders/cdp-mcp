...
internal static partial class MetaDispatch
{
        ...
        object? warm = null)
    {
        ...
        switch (name)
        {
            ...
            case "cdp_graphql":
                return CdpMcp.GraphQl.CdpGraphqlChannel.HandleJson(d.Session, d.DocStore, d.Settings, callArgs, d.DispatchToolAsync);
            case "cdp_peek":
                return CdpPeekChannel.HandleJson(d.Session, d.Settings.Languages, d.DocStore, callArgs);
            case "cdp_canon_stack":
                return IdeCanonChannel.HandleJson(d.Session, d.Settings, d.DocStore, callArgs);
            default:
                return null;
        }
    }
