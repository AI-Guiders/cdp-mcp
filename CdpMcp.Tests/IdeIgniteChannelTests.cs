...
public class IdeIgniteChannelTests : IDisposable
{
    public IdeIgniteChannelTests()
    {
        // Full-tier template pin: bind a course WITHOUT Glass/Citizen DEFERRED (canonical habitat course defers them).
