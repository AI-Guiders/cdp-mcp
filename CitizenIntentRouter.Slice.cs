...
internal static partial class CitizenIntentRouter
{
    ...
    static string? MapDrillGo(string organ)
    {
        ...
        return o switch
        {
            ...
            "dialog" or "dialog_memory" or "dialog_history" or "citizen_dialog" or "amnesia" or "forget" or "forget_context"
                or "partition" or "fork" or "persist" or "rebuild" or "antidote" or "unpoison" or "adcm" => "dialog",
