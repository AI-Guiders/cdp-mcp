    ...
    static BoardDoc BuildCdpDeskAsBuilt(string root, string name)
    {
        ...
        var ccu = AddSeedRole(doc, "ccu-core", "ccu", "ComputingUnits + Build/Loci peel (ADR 0097)", root,
            ...
            ?? AddSeedRole(doc, "ccu-build", "ccu", "IdeCockpit.Build peel", root,
                [("IdeCockpit.Build.cs", "BuildAsync")]);
        var ch = AddSeedRole(doc, "ch-core", "channel", "IChannel + DeferredSoftInstrument (ADR 0036)", root,
            [("Cockpit/Channels/IChannel.cs", (string?)null),
             ("Cockpit/Channels/DeferredSoftInstrumentChannel.cs", "Peek"),
             ("IdeCockpit.Channel.cs", "PeekDeferredSoftWants"),
             ("IdeCockpit.Channel.cs", "ApplyDeferredSoftInstruments")])
        ...
        var surf = AddSeedRole(doc, "surf-seats", "surface", "SeatsDetailGate + SoftInstrumentAlias + SoftInstruments", root,
            [("Cockpit/Surface/SeatsDetailGateUnit.cs", "Compute"),
             ("Cockpit/Surface/SeatInstrumentArgsSanitizer.cs", "Sanitize"),
             ("Cockpit/Surface/SeatFullPaneMatchUnit.cs", "Matches"),
             ("Cockpit/Surface/SeatInstrumentPanePresenter.cs", "FullOr"),
             ("Cockpit/Surface/SoftInstrumentAliasCatalog.cs", "TryResolve"),
             ...
             ("Cockpit/Surface/SoftInstrumentBoardMetaCatalog.cs", "Require"),
             ("Cockpit/Surface/ISoftInstrumentBoard.cs", "Build"),
             ("IdeSoftInstrumentBoard.cs", "Build"),
             ("Cockpit/Surface/SoftInstrumentPresentMode.cs", null),
             ("Cockpit/Surface/SeatFallbackSnapUnit.cs", "Classify"),
             ("Cockpit/Surface/SeatInstrumentPanePresenter.cs", "Present"),
             ...
             ("IdeCockpit.Surface.SoftInstruments.cs", "ResolveSeatInstrumentPaneAsync"),
             ("IdeCockpit.Dispatch.cs", "DispatchGoAsync"),
             ("Cockpit/Surface/SoftInstrumentKind.cs", "Ps1Desk"),
             ("Ps1Scene.cs", "Pulse"),
             ("IdeCockpitSoftDispatch.Operators.cs", "TryDispatchPs1"),
             ("Cockpit/Surface/SoftInstrumentKind.cs", "Report"),
