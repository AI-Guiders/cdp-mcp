...
- **0.5.640** — Soft FileLines BATCH close: densest peels (LanguageTools/CitizenChannel/RouteHostTests/Continuity) + Wire Head/Tail content-split + InstrumentsB `IsArchIntent`; densest top 341; Soft FileLines feature shipped. Lived: dual hard lag=false · VL#146. Next denser≠single peel mill.
