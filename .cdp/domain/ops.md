...
- **2026-08-16 ADR-0032 L3c VERIFY GREEN (0.5.725)** — `deploy-20260816041304-a9de7e` idle ok 7.2s · debug→sibling · `worker_exe_path`+`ignite_seat` · both **0.5.725** lag=false · `peer_ship` CDT invoked (teeth 04:13:13). Worker `WaitForArmDeliveryAsync` before exit.
