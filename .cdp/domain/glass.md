...
## last_ship
- **2026-08-04 file-situ Role-in-graph CLOSED** — Editor ECAM ROLE/GRAPH from `GlassSemanticMapGraph` hop · Face.RoleInGraph · surface `file_situ.role_in_graph` · PNG `tmp-glass-shots/window-20260804-file-situ-role-graph-mfd.png` (M·MFD · focus Nn/Ee · h1 hops lived). SoftFL invent REJECT.
