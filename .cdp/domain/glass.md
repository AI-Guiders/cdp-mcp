...
## last_ship
- **2026-08-06 HCI/HybridIndex 4a ergonomics science shot CLOSED** — nested AxB (cabin UI tree; order free). `mfd_page=HybridIndex` · `(P)(F)(M)` · title=`M · MFD host` · PNG `tmp-glass-shots/hci-hybridindex-4a-20260806.png` + `cdp_see`. SA: READY/docs/FRESH-attention/graph readable; EICAS strip stays in view. Leaf ≠ whole-cabin Done · SoftFL REJECT.
