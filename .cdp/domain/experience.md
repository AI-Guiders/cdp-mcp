...
- Experience = lived living-in-substrate (any principal: guest tip · citizen · human).
...
- Host: `HabitatExperienceLedger` (`Record` · `Snapshot` · `GetPosition` · `SetPosition` · `AffordanceFor`)
- Desk: `go=learn` / `cdp_learn` → `op=xp_scene|xp_record|xp_list|xp_position`
- Vision: agent-notes `playbook-habitat-position-experience-v1.md`
