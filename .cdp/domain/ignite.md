...
- After Intercom mirror (remount or idle-PF) + Composer Stop/Queue: habitat deliver + skip CDT (`detail=remount_composer_busy`|`idle_pf_composer_busy`) — no busy_timeout→requeue mid-flight paste. Voice/idle Composer: CDT fallthrough.
