...
internal sealed partial class CdpIgniteArmHost
{
    object Slim(IgniteArm a) => new
    {
        ...
        sdk_agent_id = a.SdkAgentId,
        delivery_path = a.DeliveryPath,
        force_cdt = a.ForceCdt,
        cursor_fire_policy = a.CursorFirePolicy,
        port = a.Port,
        once = a.Once,
    ...
    IgniteArm Clone(IgniteArm a) => new()
    {
        ...
        SdkAgentId = a.SdkAgentId,
        DeliveryPath = a.DeliveryPath,
        ForceCdt = a.ForceCdt,
        CursorFirePolicy = a.CursorFirePolicy,
        Status = a.Status,
